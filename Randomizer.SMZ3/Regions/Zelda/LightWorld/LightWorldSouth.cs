...
namespace Randomizer.SMZ3.Regions.Zelda {
    ...
    class LightWorldSouth : Z3Region {
            ...
            Locations = new List<Location> {
                ...
                new Location(this, 256+242, 0x180003, LocationType.Regular, "South of Grove",
                    items =>
                        ...
                        items.Mirror && World.CanEnter<DarkWorldSouth>(items)),
                ...
                new Location(this, 256+61, 0x180144, LocationType.Regular, "Lake Hylia Island",
                    items =>
                        Logic.OneFrameClipOw ||
                        Logic.BootsClip && items.Boots ||
                        Logic.WaterWalk && items.Boots && items.Mirror &&
                            (items.MoonPearl || Logic.OwYba && items.Bottle) &&
                            World.CanEnter<DarkWorldNorthWest>(items) ||
                        items.Flippers && items.Mirror &&
                        (items.MoonPearl || Logic.BunnySurf || Logic.OwYba && items.Bottle) &&
